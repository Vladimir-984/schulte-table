...
const tableParamsSlice = createSlice({
   ...
   reducers: {
      ...
      setTableVariant: (state, action: PayloadAction<TableVariant>) => {
         ...
         if (state.changeableParams.tableTypeSequence !== TableTypeSequence.DEFAULT) {
            state.changeableParams.tableTypeSequence = TableTypeSequence.DEFAULT
         }
      },
      ...
      setTableTypeSequence: (state, action: PayloadAction<TableTypeSequence>) => {
         // if(false){}

         state.changeableParams.tableTypeSequence = action.payload
      },
