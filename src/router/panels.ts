...
const PANEL_SETTINGS_TABLE_DISPLAY_CELLS_SHAPE = 'panel_settings_table_display_cells_shape'
...
export const PANELS = {
   ...
   SETTINGS_TABLE_DISPLAY_CELLS_SHAPE: PANEL_SETTINGS_TABLE_DISPLAY_CELLS_SHAPE,
